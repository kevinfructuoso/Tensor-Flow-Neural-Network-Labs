...
$ jupyter notebook
```
The above will open the jupyter interface in your browser from where you can access the Lab folders and the respective jupyter notebooks `DNN_lab.ipynb`